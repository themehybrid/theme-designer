 ...
 * @access public
 */
class THDS_Fields_Control_Date extends THDS_Fields_Control {
	...
	public function content_template( $post_id ) {
		...
		$year_field  = $this->get_year_field( "thds_{$this->manager->name}_setting_{$this->setting}_year",   $year  );
		$month_field = $this->get_month_field( "thds_{$this->manager->name}_setting_{$this->setting}_month", $month );
		$day_field   = $this->get_day_field( "thds_{$this->manager->name}_setting_{$this->setting}_day",     $day   ); ?>
